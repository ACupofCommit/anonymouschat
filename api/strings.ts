...
export const STR_THIS_VOICE_ID = "ID: `%s`"
...
export const STR_DEACTIVATE_WARNING_MSG = "이 채널에서 *%s* 사용이 중단되고 *%d명의* 사용자 동의 기록이 *리셋* 됩니다. 또한 이 내용은 당신의 실명과 함께 채널에 공유됩니다.\n\n정말 비활성화할까요?"
export const STR_DEACTIVATED_NOTI = "{user}님이 ＊{app_name}＊ 사용을 ＊중단＊시켰습니다. ＊{agreed_count}명＊의 유저 동의 기록이 *리셋* 되었습니다. 다시 사용하려면 아래 ＊컨피그 메시지＊를 확인하세요:\n{link}"
export const STR_ACTIVATED_NOTI = "{user}님이 ＊{app_name}＊ 사용을 ＊승인＊하였습니다. 아래 ＊컨피그 메시지＊를 참고하세요:\n{link}"
...
export const STR_LIKE = ':thumbsup: 좋아요'
export const STR_DISLIKE = ':thumbsdown: 싫어요'
export const STR_AGREE = '앱 사용 동의'
export const STR_DELETE = ':x: 삭제'
export const STR_REPLY_AS_ANON = ':pencil: 익명으로 댓글 달기'
