...
import { ChatPostMessageArguments, ChatPostEphemeralArguments, KnownBlock, ChatUpdateArguments } from '@slack/web-api'
import { ACTION_APP_USE_AGREEMENT, ACTIVATION_QUORUM, NOT_YET, ACTION_APP_FORCE_ACTIVATE, ACTION_APP_FORCE_DEACTIVATE, ACTION_OPEN_DIALOG_VOICE, CONST_SLASH_COMMAND, ACTION_SHOW_DEACTIVATE_WARNING } from '../constant'
  ...
  return [
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "style": "danger",
          "value": ACTION_SHOW_DEACTIVATE_WARNING,
        },
      ]
    },
    {
