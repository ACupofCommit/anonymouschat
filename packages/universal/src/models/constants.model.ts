...
export const ACTION_SUBMISSION_SELECT_CHANNEL_TO_SETTINGS = 'ACTION_SUBMISSION_SELECT_CHANNEL_TO_SETTINGS'
export const ACTION_SUBMISSION_SAVE_CHANNEL_SETTINGS = 'ACTION_SUBMISSION_SAVE_CHANNEL_SETTINGS'
export const ACTION_LCA2                         = 'ACTION_LCA2'
export const BLOCK_CHANNEL_CONFIG_LCA2           = 'BLOCK_CHANNEL_CONFIG_LCA2'
export const BLOCK_CHANNEL_CONFIG_REPORT_COUNT_TO_HIDE_MESSAGE = 'BLOCK_CHANNEL_CONFIG_REPORT_COUNT_TO_HIDE_MESSAGE'
export const ACTION_REPORT_COUNT_TO_HIDE_MESSAGE = 'ACTION_REPORT_COUNT_TO_HIDE_MESSAGE'
