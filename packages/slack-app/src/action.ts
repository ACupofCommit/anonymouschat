...
import { ACTION_APP_FORCE_ACTIVATE, ACTION_APP_FORCE_DEACTIVATE, ACTION_APP_USE_AGREEMENT, ACTION_ON_MORE_OPEN_VIEW_REPLY, ACTION_OPEN_DIALOG_DELETE_REPLY, ACTION_OPEN_DIALOG_DELETE_USERREPLY, ACTION_OPEN_DIALOG_DELETE_VOICE, ACTION_OPEN_DIALOG_REPLY, ACTION_OPEN_DIALOG_VOICE, ACTION_OPEN_VIEW_DELETE, ACTION_SHOW_DEACTIVATE_WARNING, ACTION_SUBMISSION_DELETE, ACTION_SUBMISSION_INIT, ACTION_SUBMISSION_REPLY, ACTION_SUBMISSION_VOICE, ACTION_VOTE_REPLY_DISLIKE, ACTION_VOTE_REPLY_LIKE, ACTION_VOTE_REPORT, ACTION_VOTE_VOICE_DISLIKE, ACTION_VOTE_VOICE_LIKE, SHORTCUT_CHANNEL_SETTINGS, SHORTCUT_START } from '@anonymouslack/universal/dist/models'
...
export const initialize = (boltApp: App) => {
  ...
  boltApp.shortcut(SHORTCUT_CHANNEL_SETTINGS, handleShortcut)
